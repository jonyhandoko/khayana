...
<?php echo form_open_multipart($this->config->item('admin_folder').'/lookbooks/form/'.$id); ?>
...
<div id="gc_tabs">
	<ul>
		<li><a href="#gc_lookbook_info"><?php echo lang('lookbook_info');?></a></li>
	</ul>
	<div id="gc_lookbook_info">
		<div class="gc_field2">
