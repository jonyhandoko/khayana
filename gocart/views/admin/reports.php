...
$(document).ready(function(){
	...
	get_sales();
	$('input:button').button();
	$('#best_sellers_start').datepicker({ dateFormat: 'yy-mm-dd', altField: '#best_sellers_start_alt', altFormat: 'yy-mm-dd' });
	$('#best_sellers_end').datepicker({ dateFormat: 'yy-mm-dd', altField: '#best_sellers_end_alt', altFormat: 'yy-mm-dd' });
});
