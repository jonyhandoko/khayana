...
<div id="gc_tabs">
    ...
    <script>
		function generateCode(){
			$.post('<?php echo site_url($this->config->item('admin_folder').'/coupons/create_guid');?>', function(data){
				$('#code').val(data);
	...
	<div id="gc_coupon_attributes">
		...
		<label><?php echo lang('coupon_code');?></label>
			<?php
			$data	= array('id'=>'code', 'name'=>'code', 'value'=>set_value('code', $code), 'readonly'=>'readonly', 'class'=>'gc_tf1');
