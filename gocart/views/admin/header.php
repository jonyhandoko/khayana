...
<title>Watch Inc Indonesia :: <?php echo  $page_title; ?></title>
...
<meta name="alexaVerifyID" content="A_Y2CAqYKatIbkbSCHMe49Hgsb4" />
<script type="text/javascript">

  var _gaq = _gaq || [];
  _gaq.push(['_setAccount', 'UA-34211225-1']);
	...
	<div id="container">
		<div id="menu_wrapper">
			...
			<div class="menu shadow">
                ...
                <a href="<?php echo $admin_url;?>payment_transfer"><?php echo 'Payment' ?></a>
			...
			<div class="menu shadow">
				...
				<a href="<?php echo $admin_url;?>attributes">Attributes</a>
			...
			<div class="menu shadow">
                ...
                <a href="<?php echo $admin_url;?>lookbooks"><?php echo lang('common_lookbooks') ?></a>
				<a href="<?php echo $admin_url;?>pages"><?php echo lang('common_pages') ?></a>
				<a href="<?php echo $admin_url;?>newsletter">Newsletters</a>
			</div>
			...
			<div class="menu shadow">
                ...
                <a href="<?php echo $admin_url;?>places"><?php echo 'JNE' ?></a>
