...
<div class="button_set">
	 <span style="float: left; padding-top: 10px; font-size: 22px; font-weight: bold;">#<?php echo $order->order_number; ?></span>
	 <a title="<?php echo 'Shipped No Number';?>" id="send_shipped" href="<?php echo site_url($this->config->item('admin_folder').'/orders/send_shipped/'.$order->id); ?>"><?php echo 'Shipped No Number';?></a> 
     <a title="<?php echo 'Insert Shipping Number';?>" id="insert_number" href="<?php echo site_url($this->config->item('admin_folder').'/orders/insert_number/'.$order->id); ?>"><?php echo 'Insert Shipping Number';?></a>     
	 <a title="<?php echo lang('send_email_notification');?>" id="notify" href="<?php echo site_url($this->config->item('admin_folder').'/orders/send_notification/'.$order->id); ?>"><?php echo lang('send_email_notification');?></a> 
     <a href="<?php echo '/invoice/'.$order->order_number.'.pdf';?>" target="_blank"><?php echo lang('packing_slip');?></a>
</div>
	...
	<tbody>
		<tr>
            ...
            <td>
				...
				<?php echo $order->ship_province.', '.$order->ship_zip;?><br/>
		...
		<tr>
			...
			<td>
                ...
                <?php if(!empty($order->shipping_number)):?><div style="margin-top:10px;"><strong>Shipping Number: </strong> <?php echo $order->shipping_number;?></div><?php endif;?>
			</td>
		</tr>
...
<table class="gc_table" cellspacing="0" cellpadding="0" style="margin-top:10px;">
	...
	<tbody>
		...
		<tr>
			<td><strong>Member Discount</strong></td>
			<td colspan="3"><?php echo $order->group_discount_percentage;?>%</td>
			<td><?php echo format_currency(0-$order->group_discount);?></td>
		</tr>
		<?php endif;?>
