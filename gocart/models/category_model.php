...
Class Category_model extends CI_Model
{
	...
	function get_category_full($id){
		return $this->db->get_where('categories', array('id'=>$id))->result();
	}
	...
	function get_category_product($id)
	{
		...
		return $this->db->get('category_products')->row();
	}
	
	function get_categories_product($id)
	{
		$this->db->select('*');
