...
?>	
	<div id="my_account_info">
		...
		<div id="address_manager">
			<?php if(count($addresses)<2){?><input type="button" class="edit_address right" rel="0" value="<?php echo lang('add_address');?>"/><?php }?>
			<h2><?php echo lang('address_manager');?></h2><span>(Max 2 addresses)</span>
