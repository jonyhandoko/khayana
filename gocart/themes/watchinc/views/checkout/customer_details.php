...
/*if(!empty($customer['ship_address']['city_id']))
{
	$ship_city_menu	= $this->Place_model->get_cities_menu($customer['ship_address']['province_id']);
}
else
{
	...
	$ship_city_menu = $this->Place_model->get_cities_menu(array_shift(array_keys($provinces)));
}*/
...
?>
	...
	<form id="customer_info_form">
		...
		<div class="thing">
			...
			<div class="col-sm-6">
			  <input type="text" class="form-control" name="ship_firstname" placeholder="first name"  value="<?php echo $customer['ship_address']['firstname'];?>">
			</div>
			<div class="col-sm-6">
			  <input type="text" class="form-control" name="ship_lastname" placeholder="last name"  value="<?php echo $customer['ship_address']['lastname'];?>">
			</div>
		  </div>
		  <div class="form-group">
			<div class="col-sm-12">
			  <input type="text" class="form-control" name="ship_address1" placeholder="address 1"  value="<?php echo $customer['ship_address']['address1'];?>">
			</div>
		  </div>
		  <div class="form-group">
			<div class="col-sm-12">
			  <input type="text" class="form-control" name="ship_address2" placeholder="address 2"  value="<?php echo (!empty($customer['ship_address']['address2']))?$customer['ship_address']['address2'].'':'';?>">
			</div>
		  </div>
		  <div class="form-group">
			<div class="col-sm-6">
			...
			<div class="col-sm-6">
			  <input type="text" class="form-control number" name="ship_zip" placeholder="zip code"  value="<?php echo $customer['ship_address']['zip'];?>">
			</div>
		  </div>
		  <div class="form-group">
			<div class="col-sm-12">
			  <input type="text" class="form-control number" name="ship_phone" placeholder="phone"  value="<?php echo $customer['ship_address']['phone'];?>">
			</div>
		  </div>
		  <div class="form-group">
			<div class="col-sm-12">
			...
			<div class="form_wrap">
				<div>
					<?php echo 'Country';?><b class="r"> *</b><br/>
					<?php echo form_dropdown('country', array("Indonesia"=>"Indonesia","Singapore"=>"Singapore"), set_value('country', $customer['ship_address']['country']), 'style="width:200px; display:block;" id="country_id" class="input"');?>
				</div>
				<div>
					<?php echo 'Province';?><b class="r"> *</b><br/>
					<?php echo form_dropdown('ship_province_id',$provinces, @$customer['ship_address']['province_id'], 'id="ship_province_id" class="ship input ship_req"');?>
				</div>
				<!--<div>
					<?php //echo 'City';?><b class="r"> *</b><br/>
					<?php //echo form_dropdown('ship_city_id',$ship_city_menu, set_value('ship_city_id',$customer['ship_address']['city_id']), 'id="ship_city_id" class="ship input ship_req"');?>
				</div>-->
			</div>
