...
class Reports extends Admin_Controller {
	...
	function sales()
	{
		$bulk_orders	= $this->Order_model->get_orders_sales();
		...
		foreach($bulk_orders as $o)
		{
			...
			$orders[$y][$m]['coupon_discounts'] += $o->coupon_discount;
                        ...
                        //group discounts
			if(!isset($orders[$y][$m]['group_discounts']))
			{
				$orders[$y][$m]['group_discounts'] = 0;
			}
			$orders[$y][$m]['group_discounts'] += $o->group_discount;
