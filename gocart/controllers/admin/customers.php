...
class Customers extends Admin_Controller {
	...
	{		
		...
		$this->load->model(array('Customer_model', 'Location_model', 'Place_model'));
	...
	{
		$addresses = $this->Customer_model->get_addresses();
		foreach($addresses as $address)
		{
			...
			$a['id']=$address['id'];
			$address['field_data']['country'] = "Indonesia";
			$a['field_data']=$address['field_data'];
	...
	function address_form($customer_id, $id = false)
	{
		...
		$this->form_validation->set_rules('province_id', 'lang:country', 'trim|required');
		//$this->form_validation->set_rules('city_id', 'lang:state', 'trim|required');
