...
class Paypal_express
{
	...
	*/
	...
	function process_payment()
	{
		...
		$convert = round($this->CI->go_cart->total(), 2);
		//$test = $this->CI->paypal->doExpressCheckout($this->CI->go_cart->contents(), $convert, $store.' order');
		//return $this->CI->paypal->doExpressCheckout($convert, $store.' order');
		$this->CI->paypal->doExpressCheckout($this->CI->go_cart->contents(), $this->CI->go_cart->shipping_cost(), $this->CI->go_cart->group_discount(), $this->CI->go_cart->coupon_discount(), $convert, $store.' order');
